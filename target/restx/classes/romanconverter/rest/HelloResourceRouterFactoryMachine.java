...
import romanconverter.rest.HelloResourceRouter;

@Machine
public class HelloResourceRouterFactoryMachine extends SingleNameFactoryMachine<romanconverter.rest.HelloResourceRouter> {
    public static final Name<romanconverter.rest.HelloResourceRouter> NAME = Name.of(romanconverter.rest.HelloResourceRouter.class, "HelloResourceRouter");

    public HelloResourceRouterFactoryMachine() {
        super(0, new StdMachineEngine<romanconverter.rest.HelloResourceRouter>(NAME, 0, BoundlessComponentBox.FACTORY) {
private final Factory.Query<romanconverter.rest.HelloResource> resource = Factory.Query.byClass(romanconverter.rest.HelloResource.class).mandatory();
...
securityManager
            ...
            @Override
            protected romanconverter.rest.HelloResourceRouter doNewComponent(SatisfiedBOM satisfiedBOM) {
