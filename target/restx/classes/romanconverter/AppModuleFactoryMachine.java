...
import romanconverter.AppModule;
...
public class AppModuleFactoryMachine extends DefaultFactoryMachine {
    ...
    public AppModuleFactoryMachine() {
        ...
        configLoader
            ...
            new StdMachineEngine<java.lang.String>(Name.of(java.lang.String.class, "restx.activation::restx.security.CORSFilter::CORSFilter"), 0, BoundlessComponentBox.FACTORY) {
                ...
                public java.lang.String doNewComponent(SatisfiedBOM satisfiedBOM) {
	                    ...
	                    return module.disableCorsFilter(
	        
	                    );
	                
                }
            },
            new StdMachineEngine<restx.RestxFilter>(Name.of(restx.RestxFilter.class, "getCorsAuthorizerFilter"), 0, BoundlessComponentBox.FACTORY) {
                ...
                public restx.RestxFilter doNewComponent(SatisfiedBOM satisfiedBOM) {
	                    ...
	                    return module.getCorsAuthorizerFilter(
